...
| **Test Results Artifact**         | `MyExporter/.artifacts/evidence/local/TestResults.xml`  | "Upload Test Results"                                     | Pester output, NUnitXml                                                       | Records pass/fail counts for downstream reporting             |
